...
def resize_and_process_image(image_path, output_dir, index, size=(128, 128)):
    ...
    cv.imwrite(os.path.join(output_dir, f"red_filtered_{index}.png"), img_resized * 255, [cv.IMWRITE_PNG_COMPRESSION, 9])
...
directory = 'datasets'
output_directory = 'datasets/OUT/images'
input_dir = os.path.join(directory, "IN", "images")
process_images_from_directory(input_dir, output_directory, "images")
